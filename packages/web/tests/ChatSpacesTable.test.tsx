...
describe('ChatSpacesTable component', () => {
  ...
  it('scenario 6: renders delete button in management column and opens DeleteChatSpaceDialog on click', () => {
    const mockSpaces = [
      {
        name: 'spaces/AAAA',
        displayName: '1학년 교무실',
    ...
    const deleteBtn = screen.getByTestId('chat-delete-btn-spaces/AAAA');
