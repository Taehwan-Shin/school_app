...
export async function callClassroomStudentsDelete(
  ...
  const url = import.meta.env.DEV
    ? `http://127.0.0.1:5001/${projectId}/asia-northeast3/classroomStudentsDelete`
    : `https://asia-northeast3-${projectId}.cloudfunctions.net/classroomStudentsDelete`;
  ...
  return (body.result ?? body) as ClassroomStudentsDeleteResponse;
}
