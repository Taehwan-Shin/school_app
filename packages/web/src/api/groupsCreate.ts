...
export async function callGroupsCreate(data: GroupsCreateRequest): Promise<GroupsCreateResponse> {
  ...
  const url = import.meta.env.DEV
    ? `http://127.0.0.1:5001/${projectId}/asia-northeast3/groupsCreate`
    : `https://asia-northeast3-${projectId}.cloudfunctions.net/groupsCreate`;
  ...
  return (body.result ?? body) as GroupsCreateResponse;
}
