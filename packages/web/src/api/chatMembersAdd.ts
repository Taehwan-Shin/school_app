...
export async function callChatMembersAdd(
  ...
  const url = import.meta.env.DEV
    ? `http://127.0.0.1:5001/${projectId}/asia-northeast3/chatMembersAdd`
    : `https://asia-northeast3-${projectId}.cloudfunctions.net/chatMembersAdd`;
  ...
  return (body.result ?? body) as ChatMembersAddResponse;
}
