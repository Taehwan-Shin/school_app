...
export async function callClassroomTeachersAdd(
  ...
  const url = import.meta.env.DEV
    ? `http://127.0.0.1:5001/${projectId}/asia-northeast3/classroomTeachersAdd`
    : `https://asia-northeast3-${projectId}.cloudfunctions.net/classroomTeachersAdd`;
  ...
  return (body.result ?? body) as ClassroomTeachersAddResponse;
}
