...
export async function callGroupsUpdate(data: GroupsUpdateRequest): Promise<GroupsUpdateResponse> {
  ...
  const url = import.meta.env.DEV
    ? `http://127.0.0.1:5001/${projectId}/asia-northeast3/groupsUpdate`
    : `https://asia-northeast3-${projectId}.cloudfunctions.net/groupsUpdate`;
  ...
  return (body.result ?? body) as GroupsUpdateResponse;
}
