...
export async function callClassroomTeachersDelete(
  ...
  const url = import.meta.env.DEV
    ? `http://127.0.0.1:5001/${projectId}/asia-northeast3/classroomTeachersDelete`
    : `https://asia-northeast3-${projectId}.cloudfunctions.net/classroomTeachersDelete`;
  ...
  return (body.result ?? body) as ClassroomTeachersDeleteResponse;
}
