...
export async function callGroupsDelete(data: GroupsDeleteRequest): Promise<GroupsDeleteResponse> {
  ...
  const url = import.meta.env.DEV
    ? `http://127.0.0.1:5001/${projectId}/asia-northeast3/groupsDelete`
    : `https://asia-northeast3-${projectId}.cloudfunctions.net/groupsDelete`;
  ...
  return (body.result ?? body) as GroupsDeleteResponse;
}
