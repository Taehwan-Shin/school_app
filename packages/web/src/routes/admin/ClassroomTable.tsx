...
export function ClassroomTable() {
  ...
  // v0.201: 컬럼 표시 여부 (Set<K>) + 4 helper. v0.292: useVisibleColumns hook shared.
  const {
    visibleColumns,
    setVisibleColumns,
    toggleColumn,
  ...
  // v0.294: shared resetTablePreferences helper.
  ...
  return (
    <div className="space-y-4">
      ...
      <Banner variant="success" message={successBanner} testId="classroom-success-banner" />
