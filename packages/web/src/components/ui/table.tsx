...
//          기존 사용처 5곳 (UserAuditTrail/GroupAuditTrail/UserGroups/AuditLogTable/super_admin index) 이
...
>(({ className, truncate = false, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "px-4 py-3 text-body text-fg-primary align-middle [&:has([role=checkbox])]:pr-0",
