...
- **AccountsTable 컬럼 표시 토글** - v0.199 완료 (pattern 정립). 「컬럼 표시 (N / 4)」 popover menu · TOGGLEABLE_COLUMNS 4 필드 (name/orgUnitPath/admin/suspended) · localStorage `accountsTable.visibleColumns.v1` (JSON array) · 헤더/셀 조건부 렌더링 · 5 회귀 · 웹 1130 (+5). v0.200/v0.201 로 GroupsTable/ClassroomTable 대칭 확장 예정.
