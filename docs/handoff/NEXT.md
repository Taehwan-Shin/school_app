...
> **v0.182 병합 완료** (`6c60b80`) - NEIS CSV import 코스 이름 750자 상한 검증 (v0.176 BulkRename row-level 패턴을 v0.145 dialog preview 에 이식) · 기계 관문 (lint clean · web 1068 유닛) 통과 · Codex R1 skip.
