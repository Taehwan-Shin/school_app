...
> **v0.117 병합 완료** (`c44f73f`) — classroom 상세 페이지 · 2 라운드 Codex 감사.

## 최근 병합 (참고, 상세는 `project_notes.md`)

- `c44f73f` v0.117 — classroom 상세 페이지 (`/admin/classrooms/:id`) + F80/F81.
- `70fac11` v0.116 — 클래스룸 소유자 이관 (transferOwnership callable + Dialog + F72~F77·F79).
...
`docs/handoff/ROADMAP.md` Phase 6 통합·자동화:
- **감사 로그 배치 export** — 전체 페이지 순회 (hasMore 소진까지) 통합 JSON/CSV.
- **admin/users 검색 필터** — client-side 이메일·이름 검색.
- **super_admin 대시보드 위젯** — 최근 활동 요약.
