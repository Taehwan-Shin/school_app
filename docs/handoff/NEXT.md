...
> **v0.178 병합 완료** (`fd88dbb`) - CreateUser/BatchCreate 성/이름 60자 상한 검증 (Google Directory User 규격 · v0.173/v0.174/v0.175/v0.176 시리즈 대칭) · 기계 관문 (lint clean · web 1050 유닛) 통과 · Codex R1 skip (Head 폴백).
