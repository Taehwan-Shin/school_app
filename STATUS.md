...
| 항목 | 담당 | 상태 | 확인 방법 |
|---|---|---|---|
| 다음 제품 방향 확정 (v0.102+) | 사용자 | 답 대기 | (a)(b) 완료 · (b3) 감사 액션 필터 (v0.101) 완료. 다음 후보: (c) 실 Workspace 확인 workflow · (b4) 감사 로그 다중 액션·행위자 필터 · (d) 그 외 |
...
| 버전 | 커밋 | 요약 |
|---|---|---|
| v0.101 | `bb5a8f5` (main) | 감사 액션 필터 — AUDIT_ACTIONS shared 카탈로그 · readAudit/list filterAction (서버 정확 매치) · AuditLogTable 액션 드롭다운 · q substring 검색 message 확장 (role_split 탐색) · audit_log(action, at DESC) 복합 인덱스 · 2 라운드 Codex 감사 |
