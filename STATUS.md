...
| 항목 | 담당 | 상태 | 확인 방법 |
|---|---|---|---|
| 다음 제품 방향 확정 (v0.129+) | 사용자 | 답 대기 | v0.104~v0.128 병합 완료. 후보: 전입생 계정 UX 세부 (도메인 규칙 필요) · audit sink 인프라 (사용자 조치) · 남은 Bulk dialog 하드닝 (MoveOu/ResetPassword/RemoveMembers) · (d) 그 외 |
