...
| Firebase 프로젝트 구조 v0.10 (감사 9차 반영) | 헤드 | 커밋됨 | `docs/design/firebase_layout.md` v0.10 · 신원 토큰 함수별 서비스 계정 · idempotency 원자적 create · (b) 선택 시 별도 문서 분리 |
| Codex 10차 감사 (v0.10 회귀 없음 확인) | 감사 | 대기 | 새 실패 없음이면 v1.0 승격 준비 완료 |
